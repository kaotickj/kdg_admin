...
if (!empty ($_GET['page'])) {
	...
	?>
				...
				<meta property="og:image" content="assets/img/bg.jpg" />
				<meta property="og:title" content="Hernandez Brothers" />
				<meta property="og:url" content="<?php echo $siteURL;?>" />
				<meta property="og:site_name" content="Hernandez Brothers" />
				<meta property="og:description" content="Every cup of our quality artisan coffee starts with locally sourced, hand picked ingredients. Once you try it, our coffee will be a blissful addition to your everyday morning routine - we guarantee it!" />
<?php
}
?>
